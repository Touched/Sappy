...
Begin VB.Form frmSappy 
   ...
   Begin VB.PictureBox picTop 
      ...
      Top             =   0
      Width           =   4860
      Begin Sappy2k6.SkinButton cmdStop 
         Height          =   495
         Left            =   4310
         TabIndex        =   6
         Top             =   765
         ...
         Enabled         =   0   'False
      End
      Begin Sappy2k6.SkinButton cmdPrevSong 
         Height          =   330
         Left            =   960
         TabIndex        =   8
         Top             =   120
         ...
         Enabled         =   0   'False
      End
      Begin Sappy2k6.SkinButton cmdNextSong 
         Height          =   330
         Left            =   4380
         TabIndex        =   11
         Top             =   120
      ...
      Begin VB.TextBox txtSong 
         ...
         Width           =   495
      End
      Begin Sappy2k6.SkinButton cmdPlay 
         Height          =   495
         Left            =   3820
         TabIndex        =   5
         Top             =   765
...
Private Sub cmdPlay_Click()
  ...
  SappyDecoder.GlobalVolume = VolumeSlider1.GetValue * 5.1
  ...
  If GetSettingI("mIRC Now Playing") Then
    Open App.Path & "\sappy.stt" For Output As #43
    Print #43, songinfo
    Close #43
  End If
...
Private Sub cmdStop_Click()
  ...
  If GetSetting("mIRC Now Playing") Then
    Open App.Path & "\sappy.stt" For Output As #44
    Print #44, App.Major & "." & App.Minor & "| | | |Not running|"
    Close #44
  End If
...
Private Sub Form_Unload(Cancel As Integer)
  ...
  If GetSettingI("mIRC Now Playing") Then
    ...
    Open App.Path & "\sappy.stt" For Output As #42
...
Public Sub LoadGameFromXML(gamecode As String, Optional ByVal newxfile As String = "")
  ...
  Dim i As Integer, j As Integer, Icon As Integer, picon As Integer
      ...
      For Each n2 In n1.childNodes
        If n2.baseName = "playlist" Then
          ...
          Else
            cbxSongs.AddItemAndData n2.getAttribute("name"), 13, 13, 9999
            picon = 14
            If n2.getAttribute("icon") = "1" Then picon = 25
            playlist(NumPLs).NumSongs = 0
            For Each n4 In n2.childNodes
              If n4.baseName = "song" Then
                Icon = picon
                If n4.getAttribute("icon") = "0" Then Icon = 14
                If n4.getAttribute("icon") = "1" Then Icon = 25
...
Private Sub mnuGBMode_Click()
  ...
  WriteSettingI "MIDI In GB Mode", Abs(mnuGBMode.Checked)
End Sub
...
Private Sub mnuSeekPlaylist_Click()
  ...
  WriteSettingI "Seek by Playlist", Abs(mnuSeekPlaylist.Checked)
End Sub
...
Private Sub SappyDecoder_Beat(ByVal Beats As Long)
...
Private Sub SappyDecoder_Loading(ByVal status As Integer)

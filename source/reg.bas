...
'-------------------------------------------------------------------------------------------------
'sample usage - Trace UpodateKey(HKEY_CLASSES_ROOT, "keyname", "newvalue")
'-------------------------------------------------------------------------------------------------
...
'-------------------------------------------------------------------------------------------------
'sample usage - Trace GetKeyValue(HKEY_CLASSES_ROOT, "COMCTL.ListviewCtrl.1\CLSID", "")
'-------------------------------------------------------------------------------------------------
...
Public Function UpdateKeyI(KeyRoot As Long, KeyName As String, SubKeyName As String, SubKeyValue As Integer) As Boolean
  Dim rc As Long
  Dim hKey As Long
  Dim hDepth As Long
  ...
  rc = RegSetValueEx(hKey, SubKeyName, 0, REG_DWORD, SubKeyValue, 4)
  If (rc <> ERROR_SUCCESS) Then GoTo CreateKeyError
  rc = RegCloseKey(hKey)
  UpdateKeyI = True
  Exit Function
...
Public Function GetKeyValueI(KeyRoot As Long, KeyName As String, SubKeyRef As String) As Integer
  Dim i As Long
  Dim rc As Long
  Dim hKey As Long
  Dim hDepth As Long
